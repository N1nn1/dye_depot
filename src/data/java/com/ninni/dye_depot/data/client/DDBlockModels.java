...
public class DDBlockModels extends BlockStateProvider {
    ...
    private void flag(Holder<? extends Block> block) {
        ...
        itemModels()
            .withExistingParent(key(block).toString(), new ResourceLocation(ModCompat.SUPPLEMENTARIES, "item/flag_black"));
    }
    ...
    private void present(DyeColor color, Holder<? extends Block> block) {
        ...
        itemModels()
            .withExistingParent(key(block).toString(), new ResourceLocation(ModCompat.SUPPLEMENTARIES, "block/" + type + "s/" + color + "_closed"));
    }

    private ResourceLocation withDefaultNamespace(String name) {
