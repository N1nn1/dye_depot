...
public interface DispenseItemBehaviourMixin {
    ...
    @WrapWithCondition(
        method = "bootStrap",
        at = @At(value = "INVOKE", ordinal = 74, target = "Lnet/minecraft/world/level/block/DispenserBlock;registerBehavior(Lnet/minecraft/world/level/ItemLike;Lnet/minecraft/core/dispenser/DispenseItemBehavior;)V")
    )
