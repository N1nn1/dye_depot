...
public class DDCreativeModeTabs {
    static {
        ...
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.COLORED_BLOCKS).register(entries -> {
            ...
            entries.addBefore(RED_SHULKER_BOX, SHULKER_BOXES.get(DDDyes.MAROON.get()), SHULKER_BOXES.get(DDDyes.DYEDEPOT_ROSE.get()));
            entries.addAfter(RED_SHULKER_BOX, SHULKER_BOXES.get(DDDyes.DYEDEPOT_CORAL.get()));
