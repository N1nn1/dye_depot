...
public class DDItems {
    ...
    public static final Item ROSE_DYE = register("rose_dye", new DyeItem(DDDyes.DYEDEPOT_ROSE.get(), new Item.Properties()));
    public static final Item CORAL_DYE = register("coral_dye", new DyeItem(DDDyes.DYEDEPOT_CORAL.get(), new Item.Properties()));
